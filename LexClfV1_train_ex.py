...
if __name__ == '__main__':
	...
	for run in range(10):
		...
		max_perf = clf.save_best_clf(max_perf, freq_dev_inputs, freq_dev_ranks, freq_dev_supersenses, rand_dev_inputs, rand_dev_ranks, rand_dev_supersenses, classifier, params, path, DEVICE)
