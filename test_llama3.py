...
prompt = """Définition: Chien qui vit en meute dans les montages. Classe sémantique: Animal.
			Définition: Sport d'endurance. Classe sémantique: Act.
			Définition: Végétal de couleur sombre. Classe sémantique: """
