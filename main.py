...
if __name__ == '__main__':
	...
	print(train_examples_encoder.bert_input)
	print(train_examples_encoder.tg_trks)
	print(train_examples_encoder.supersenses_encoded)
	print(train_examples_encoder.senses_ids)
	print(train_examples_encoder.lemmas)
